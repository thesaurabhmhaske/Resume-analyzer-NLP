...
def run():
    ...
    if choice == 'User':
        ...
        # Upload Resume
        st.markdown('''<h5 style='text-align: left; color: #fff;'> Upload Your Resume, And Get Smart Recommendations</h5>''',unsafe_allow_html=True)
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if act_jd:
                    resume_score = int(calculate_similarity(act_jd, resume_text))
